...
const Fun = () => {
    ...
    useEffect (() => {
        ...
        const createAsteroidBelt = () => {
            ...
            for (var i = 0; i < ROID_NUM + level; i++) {
                ...
                roids.push(newRrhoid(x, y, Math.ceil(ROID_SIZE / 2)));
            }
        }

        const newRrhoid = (x, y, r) => {
    ...
    //    var music = new Music("sounds/music-low.m4a", "sounds/music-high.m4a");
        ...
        const destroyAsteroid = (index) => {
            ...
            if (r == Math.ceil(ROID_SIZE / 2)) { // large 'roids' XD
                roids.push(newRrhoid(x, y, Math.ceil(ROID_SIZE / 4)));
                roids.push(newRrhoid(x, y, Math.ceil(ROID_SIZE / 4)));
                score += ROID_PTS_LGE;
            } else if (r == Math.ceil(ROID_SIZE / 4)) { // medium asteroid
                roids.push(newRrhoid(x, y, Math.ceil(ROID_SIZE / 8)));
                roids.push(newRrhoid(x, y, Math.ceil(ROID_SIZE / 8)));
                score += ROID_PTS_MED;
            } else {
                score += ROID_PTS_SML;
        ...
        const drawShip = (x, y, a, colour = "white") => {
        ...
        //     this.setAsteroidRatio = const(ratio) {
        ...
        // const Sound = (src, maxStreams = 1, vol = 1.0) => {
        //     this.streamNum = 0;
        //     this.streams = [];
        ...
        const gameInterval = setInterval(update, 1000 / FPS);
